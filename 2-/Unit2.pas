...
begin
  ...
  memo1.Lines.Add('======== Retornmo sem o método');
...
begin
  ...
  lSomaref := SomaRef(soma); //Soma Ref Altera o valor da variável, ou seja,
  // passei a referência da varíavel para ajudar na soma, e não apenas o valor
  memo1.Lines.Add('======== Por referências (Function)');
  memo1.Lines.Add('Retorno de soma: ' + soma.ToString);
  memo1.Lines.Add('Retorno de lSomaRef: ' + lSomaref);

  lOut := 10;
  Calculo(3,lOut);
  memo1.Lines.Add('Metodo sem retorno com referências; ' + lOut.ToString);
end;
